...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, fig.width = 14, fig.height = 10) 
...
In this module, I wanted to look at the future of the SF position in the NBA. The season has just started and I'm really excited this year.
